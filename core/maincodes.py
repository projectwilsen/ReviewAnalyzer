...
def video_stats(youtube, videoIDs, channelID = None, to_csv=False):
...
def send_email_with_attachment(videoid,sender_email, sender_password, recipient_email, subject, message, attachment_content):
